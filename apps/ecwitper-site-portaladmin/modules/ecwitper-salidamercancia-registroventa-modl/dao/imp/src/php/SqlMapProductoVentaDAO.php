...
require_once 'apps/ecwitper-site-portaladmin/modules/ecwitper-registro-venta-modl/dao/model/src/php/ProductoVenta.php';
require_once 'apps/ecwitper-site-portaladmin/modules/ecwitper-registro-venta-modl/dao/ifz/src/php/ProductoVentaDAO.php';
...
class SqlMapProductoVentaDAO implements ProductoVentaDAO{
    ...
    public function selectProductoVentas($dataRequest){
		...
		$sql  = "select pt.cod_producto, pt.mini_codigo, pt.cod_fabricante, fb.marca, pt.cod_tipcategoria, pt.cod_categoria, pt.cod_subcategoria, pt.producto, pt.descrip_corta, pt.descrip_larga "
				.", pt.ind_especificaciones, pt.ind_galeriaImagenes, imagen_sm, key_word, pt.precio_compra_final, precio_venta_normal, pt.precio_venta_internet "
