...
// ----------------------------------------------------------------------------
// Change History:
//  21/07/2019  degui <degui@nitper.com>
//     - Se crea la calse pedido
// ----------------------------------------------------------------------------
...
class Pedido{
    ...
    private $medio_pago;
    private $comentario;
    private $doctip_cliente;
    private $docnum_cliente;
    ...
    public function get_doctip_cliente(){
    	   return $this->doctip_cliente;
    }
    public function set_doctip_cliente($doctip_cliente){
    	   $this->doctip_cliente=$doctip_cliente;
    }
    public function get_docnum_cliente(){
    	   return $this->docnum_cliente;
    }
    public function set_docnum_cliente($docnum_cliente){
    	   $this->docnum_cliente=$docnum_cliente;
    }
    ...
    public function toArray(){
    	   return $data = array(
		    ...
		    "doctip_cliente" => $this->doctip_cliente,
		    "docnum_cliente" => $this->docnum_cliente,
