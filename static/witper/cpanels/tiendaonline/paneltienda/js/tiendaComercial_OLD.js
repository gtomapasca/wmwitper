...
function cargarPaginaSeleccionada(){
    ...
    if(opcion == "inicio"){
		//cargarPagina("cpanels/tiendaonline-cpanel/acceso/menu-store/opcion-inicio");
		//cargarPagina("cpanel/store/catalogo/menu-store/opcion-inicio");
	...
	// cargar pagina producto con datos del producto seleccionado
		...
		//cargarPagina("cpanels/tiendaonline/acceso/menu-store/opcion-producto-sel/?mc="+valor);
		//cargarPagina("apps/tiendaonline-web/acceso/consultar-catalogo-productos/cargar-producto-sel/?mc="+valor);
