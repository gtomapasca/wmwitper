...
function mostrarResultadoPost(datos){		
	...
	for(let item of datos){
		...
		html += '		    <p><a href="javascript:cargarPagina(\'app/store/blog/CPModal-publicador-articulos/mostrar-articulo-sel/?id='+item.cod_articulo+'\')"><img src="'+item.imagen_sm+'" class="img-responsive"></a></p>';
		...
		html += '		    <p><b><a href="javascript:cargarPagina(\'app/store/blog/CPModal-publicador-articulos/mostrar-articulo-sel/?id='+item.cod_articulo+'\')">'+item.titulo+'</a></b></p>';
		html += '		    <p>'+item.resumen+'<a href="javascript:cargarPagina(\'app/store/blog/CPModal-publicador-articulos/mostrar-articulo-sel/?id='+item.cod_articulo+'\')">Leer más</a></p>';
		html += '		</article>';
		html += '	      </section>';
	}
	html += '	    </div>';
