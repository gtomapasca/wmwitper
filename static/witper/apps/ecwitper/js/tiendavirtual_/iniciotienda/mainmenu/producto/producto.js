...
function mostrarProductoSeleccionado(datos){
    ...
    let twProducto = "https://twitter.com/intent/tweet?text="+texto+"&url="+url+"&via=compuchiclayo&hashtags=Chiclayo,Lambayeque";
    let fbProducto = "https://www.facebook.com/sharer/sharer.php?u="+url+"&t="+texto;
    let wsProducto = "whatsapp://send?text="+url;
