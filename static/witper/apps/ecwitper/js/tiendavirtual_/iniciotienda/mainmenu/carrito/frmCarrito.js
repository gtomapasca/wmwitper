    ...
    witper_getListCar(null, function(errorLanzado, datosDevuelto){
		if(errorLanzado == null){
			...
			if(exito){
					...
					html += "			<h2>Carrito::Carrito de Compras</h2>";
					html += "			<h4>Vaya!, su carrito se encuentra vacío...</h4>";
					html += "			<p>Seleccione los productos de su preferencia en nuestra";
...
function mostrarListaCarrito(datos){
	try { 
		...
		html += "		<h2>Carrito::Carrito de Compras</h2>";
		html += "		<h4>Lista de productos añadidos al carrito:</h4>";
		html += "<table border='1'>";
		html +=	  "<tr>";
		html +=		"<td class='colorItems' style='padding:5px; text-align:center;'><b>Item</b></td>";
		...
		html +=		"<td style='padding:5px; text-align:center;'><b>opciones</b></td>";
		html +=	  "</tr>";
